...
<div className="recommendations">
    <div className="container">
        ...
        <div className="filterWrap">
            <div className="filterWrap__title">Filters <button className="filterWrap__close closeFilter"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px"
